...
- J'ai également créé [neurarium](https://github.com/thiswillbeyourgithub/neurarium) : une visualisation 3D interactive du cerveau pour explorer la neuroanatomie et la connectivité directement dans le navigateur. Les régions cérébrales apparaissent sous forme de formes 3D et leurs projections sous forme de flèches colorées selon le type de neurone (excitateur, inhibiteur, dopaminergique), et vous pouvez tourner, zoomer, couper par transparence et écarter les régions pour révéler les structures internes. C'est volontairement minimaliste : JavaScript vanilla et [three.js](https://threejs.org/) intégré localement, sans framework ni étape de build, servi depuis un conteneur Caddy renforcé sur le plan de la sécurité avec une CSP stricte.
