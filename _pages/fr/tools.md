...
J'ai également créé [Parakeet Web](https://github.com/thiswillbeyourgithub/parakeet_web) : transcription vocale directement dans le navigateur, avec un fort accent sur la confidentialité et la sécurité — aucune installation, aucune donnée envoyée à un serveur. Je travaille sur un modèle médical amélioré et de meilleures fonctionnalités de dictée. Une instance publique est disponible sur [parakeetweb.olicorne.org](https://parakeetweb.olicorne.org).
