...
## Par e-mail
Utilisez "`mail` le symbole @ `oliviercornelis.fr`".
...
Classés par "probabilité la plus élevée que je voie votre message" en premier :

- Sur [Github](https://github.com) contactez-moi en utilisant `@thiswillbeyourgithub` dans n'importe quelle issue ou discussion Github. Je recevrai un e-mail prioritaire pour y jeter un œil. Si vous ne souhaitez pas que notre conversation soit publique, vous pouvez m'inviter dans un dépôt privé pour discuter via des issues ou discussions.
- Sur [~~Bluesky~~ Eurosky](https://en.wikipedia.org/wiki/Bluesky) en tant que [@olicorne.eurosky.social](https://bsky.app/profile/olicorne.eurosky.social). Pour migrer de Bluesky à Eurosky en quelques minutes, utilisez l'[outil de migration Eurosky](https://eurosky.tech/accounts/migrate).
...
- Sur [simplex-chat](https://github.com/simplex-chat/simplex-chat) via [mon lien d'invitation SimpleX](https://smp8.simplex.im/a#zhJ22L47TjVY2dY_SsMv8v0JqsSwzQ-Qp0kbGO1nUo4) ou [son QR Code](https://olicorne.org/images/simplex.png).
