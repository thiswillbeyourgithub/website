...
- Pour interroger ma large collection de documents médicaux en langage naturel, j'ai créé [wdoc](https://github.com/thiswillbeyourgithub/wdoc/), un outil basé sur le RAG capable d'ingérer des dizaines de formats de fichiers et de résumer récursivement des documents de longueur arbitraire. Il s'est avéré précieux pour trouver rapidement des sources officielles dans des situations médicales critiques, et a depuis été utilisé par des avocats et d'autres professionnels.
