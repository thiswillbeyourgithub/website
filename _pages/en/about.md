...
I started coding when I was about 12. I've always been deeply committed about open source - every time possible I make my code publicly available on [my github](https://github.com/thiswillbeyourgithub/). Here are some statistics:
...
- Tinkering with [high dimensional embeddings](https://en.wikipedia.org/wiki/Embedding_(machine_learning)) led me to create [QuestEA](https://github.com/thiswillbeyourgithub/QuestEA) and discuss it with researchers working on related questions. The goal being to uncover hidden patterns in medical questionnaires allowing to unify partially disjointed medical datasets.
- To query my large collection of medical documents using natural language, I created [wdoc](https://github.com/thiswillbeyourgithub/wdoc/), a RAG-based tool that can ingest dozens of file formats and recursively summarize arbitrarily long documents. It turned out to be genuinely handy for finding official sources quickly in relatively high-stakes medical situations, and has since sparked interest among lawyers and other professionals.
