...
- To query my large collection of medical documents using natural language, I created [wdoc](https://github.com/thiswillbeyourgithub/wdoc/), a RAG-based tool that can ingest dozens of file formats and recursively summarize arbitrarily long documents. It turned out to be crucial for finding official sources quickly in relatively high-stakes medical situations, and has since sparked interest among lawyers and other professionals.
