...
*24 projects so far*
- [parakeet-tdt-0.6b-v3-smoothquant-onnx](https://huggingface.co/Olicorne/parakeet-tdt-0.6b-v3-smoothquant-onnx): SmoothQuant-quantized ONNX export of NVIDIA's [Parakeet TDT 0.6b v3](https://huggingface.co/nvidia/parakeet-tdt-0.6b-v3) speech recognition model, hosted on [HuggingFace](https://huggingface.co/). An improved version of the [reference ONNX export](https://huggingface.co/istupakov/parakeet-tdt-0.6b-v3-onnx) used everywhere. A smaller, faster-to-run version meant for in-browser transcription (see [Parakeet Web](https://github.com/thiswillbeyourgithub/parakeet_web) below).
...
- [Parakeet Web](https://github.com/thiswillbeyourgithub/parakeet_web): voice transcription directly inside the browser (no data sent to any server). I have an instance running at [parakeetweb.olicorne.org](https://parakeetweb.olicorne.org). I'm also working on a medical finetune (see [AudioCrowd](https://github.com/thiswillbeyourgithub/AudioCrowd) for the data collection side).
