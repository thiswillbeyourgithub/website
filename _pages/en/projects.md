...
*24 projects so far*
- [parakeet-tdt-0.6b-v3-smoothquant-onnx](https://huggingface.co/Olicorne/parakeet-tdt-0.6b-v3-smoothquant-onnx): SmoothQuant-quantized ONNX export of NVIDIA's [Parakeet TDT 0.6b v3](https://huggingface.co/nvidia/parakeet-tdt-0.6b-v3) speech recognition model, hosted on [HuggingFace](https://huggingface.co/). A smaller, faster-to-run version meant for in-browser transcription (see [Parakeet Web](https://github.com/thiswillbeyourgithub/parakeet_web) below).
