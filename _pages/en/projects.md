...
*18 projects so far*
- [WebSend](https://github.com/thiswillbeyourgithub/WebSend): Secure peer-to-peer document scanner that encrypts photos directly between devices using WebRTC, ensuring sensitive data never passes through unencrypted servers. I run an instance at [imagesecuresend.olicorne.org](https://imagesecuresend.olicorne.org/).
...
- [Parakeet Web](https://github.com/thiswillbeyourgithub/parakeet_web): voice transcription directly inside the browser (no data sent to any server). I have an instance running at [pw.olicorne.org](https://pw.olicorne.org). I'm also working on a medical finetune.
