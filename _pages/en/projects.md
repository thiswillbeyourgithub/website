...
*18 projects so far*
- [ImageSecureSend](https://github.com/thiswillbeyourgithub/ImageSecureSend): Secure peer-to-peer document scanner that encrypts photos directly between devices using WebRTC, ensuring sensitive data never passes through unencrypted servers. I run an instance at [imagesecuresend.olicorne.org](https://imagesecuresend.olicorne.org/).
