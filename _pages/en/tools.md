...
# Helper tools
- I built [neurarium](https://neurarium.olicorne.org/?lang=en): an interactive 3D brain visualization for exploring neuroanatomy and connectivity directly in the browser. Brain regions appear as 3D shapes and their projections as color-coded arrows by neuron type (excitatory, inhibitory, dopaminergic), and you can rotate, zoom, slice through transparency and pull regions apart to reveal internal structures. It's deliberately minimal: vanilla JavaScript and locally vendored [three.js](https://threejs.org/) with no framework or build process, served from a security-hardened Caddy container with a strict CSP. There's a public instance at [neurarium.olicorne.org](https://neurarium.olicorne.org/?lang=en) and the source is on [GitHub](https://github.com/thiswillbeyourgithub/neurarium).

  [![neurarium](https://github.com/thiswillbeyourgithub/neurarium/raw/refs/heads/main/docs/preview.gif)](https://neurarium.olicorne.org/?lang=en)
